...
func Preamble(version string) {
	...
	fmt.Println()
	fmt.Println("Email: admin@denarius.io")
	fmt.Println("Phantom for Denarius: github.com/carsenk/phantom")
	fmt.Println("Twitter: @carsenjk")
	fmt.Println("Discord: Carsen#3333")
	fmt.Println()
	fmt.Println("Donation addresses:")
	fmt.Println("D: DMciTRDMZzcL48JoB1NJu5vhMkVuJLxhJe")
	fmt.Println()
	fmt.Println()
}